    ...
    ui(new Ui::SecurityCloudStorageClientWidget)
{
    ...
    connect(ui->search_tabWidget,SIGNAL(tabCloseRequested(int)),this,SLOT(slot_search_result_tabwidget_closed(int)));//绑定页签关闭触发的信号与槽函数
...
void SecurityCloudStorageClientWidget::slot_search_result_tabwidget_closed(int index){
    ui->search_tabWidget->removeTab(index);//关闭页签
}
