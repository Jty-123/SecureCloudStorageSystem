...
void UploadOperation::generateMetadata(){
    ...
    metadatajsonvar.insert("ctime", ctime.toString("yyyy-MM-dd hh:mm:ss"));
    metadatajsonvar.insert("mtime", mtime.toString("yyyy-MM-dd hh:mm:ss"));
    metadatajsonvar.insert("lastaccesstime", lastaccesstime.toString("yyyy-MM-dd hh:mm:ss"));
    metadatajsonvar.insert("uploadtime", uploadtime.toString("yyyy-MM-dd hh:mm:ss"));
